...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void StoreRroductInformation() {
        loadingBar.setTitle("Add new product");
        loadingBar.setMessage("Dear Seller , Please wait while we are adding the products");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(AdminAddNewProductActivity.this, "Product image is uploaded successfully", Toast.LENGTH_SHORT).show();
